...
public class Dictionary {
  ...
  public static void main(String arg[]) throws Exception
   {
	File file1=new File("C:\\Users\\parmar\\Downloads\\HW2-dictionary.txt");     //reading dictionary file
	Scanner sc1=new Scanner(file1);
	File file2=new File("C:\\Users\\parmar\\Downloads\\HW2-Keywords.txt");       //reading keyword file
	Scanner sc2=new Scanner(file2);
	
	FileWriter fw=new FileWriter("C:\\Users\\parmar\\Desktop\\Output1.txt");     // creating output class
